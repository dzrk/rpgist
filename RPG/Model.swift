...
class Model
{
    ...
    var secondaryColours = [UIColor(red: 0.522, green:0.78, blue: 0.949, alpha:1.0), UIColor.white, UIColor.lightGray, UIColor.yellow, UIColor.green]
    ...
    var secondaryColourFlags = [true, true, true, false, false]
